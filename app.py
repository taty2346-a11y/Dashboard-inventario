...
if archivo_sistema and archivo_fisico:
   ...
   if st.sidebar.button("🚀 Ejecutar Comparativa"):
       try:
           # Seleccionar columnas y forzar limpieza
           df_sis_clean = df_sis[[sku_sis, cant_sis]].copy()
           df_fis_clean = df_fis[[sku_fis, cant_fis]].copy()
           # FORZAR A NÚMERICO: convierte errores a NaN y luego a 0
           ...
           st.error(f"Error técnico: {e}. Asegúrate de haber seleccionado las columnas correctas en la barra lateral.")
else:
